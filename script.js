...
(function () {
  ...
  const STRINGS = {
    pt: {
      ...
      "dl-h2": "Windows, para começar.",
      "dl-lead": "Aplicação desktop nativa para Windows 11 (64-bit), sem instalação — extrair e abrir. Ainda não lançada. macOS e Linux não fazem parte da primeira versão.",
      "dl-version": "Windows 11 · 64-bit · portátil",
      "dl-soon": "Brevemente",
      ...
      "faq-4-a": "Conta com cerca de 150 MB numa cidade pequena: as texturas vão embutidas no GLB, para abrir em qualquer lado sem ficheiros em falta. Exporta por categorias (um GLB por gerador) e importa só o que precisas, e reduz a densidade de árvores nas definições de colocação (Trees: sparse ou off).",
      "faq-5-q": "Há suporte para macOS ou Linux?",
      "faq-5-a": "Não na primeira versão — é só Windows 11 (64-bit). Ambos são tecnicamente possíveis e estão na lista para depois do lançamento.",
      "faq-8-q": "Que tamanho de cidade dá para gerar?",
      "faq-8-a": "Medido: até cerca de 60 ruas (um bairro, ~360 m) gera em cerca de 7 segundos — é o tamanho em que se itera. 100–250 ruas leva dezenas de segundos. Acima de 250 ruas não é recomendado na primeira versão: divide a cidade em projetos por distrito. Threading real e tiles automáticos vêm depois do lançamento.",
      "faq-9-q": "Posso usar as cidades geradas num jogo comercial?",
      "faq-9-a": "Sim. Usa as cidades geradas e os assets incluídos em qualquer produto teu, comercial ou não, sem royalties e sem atribuição obrigatória. A única coisa que não podes fazer é revender os assets em si como biblioteca. Texto completo: <a href=\"legal.html\">licenças</a>.",
      // Footer
      "footer-desc": "Uma app para desenhar, gerar e povoar cidades procedurais.",
      "footer-asset-licence": "Licença de assets",
      "footer-eula": "Licença da aplicação (EULA)",
      "footer-meta": "© 2026 · Kaia · Todos os direitos reservados",
      // Page title
    ...
    en: {
      ...
      "dl-eyebrow": "Downloads",
      "dl-h2": "Windows, to start with.",
      "dl-lead": "Native desktop app for Windows 11 (64-bit), no install needed — unzip and run. Not released yet. macOS and Linux are not part of the first version.",
      "dl-version": "Windows 11 · 64-bit · portable",
      "dl-soon": "Coming soon",
      ...
      "faq-4-a": "Expect around 150 MB for a small city: textures are embedded in the GLB so it opens anywhere without missing files. Export by category (one GLB per generator) and import only what you need, and reduce tree density in the placement settings (Trees: sparse or off).",
      "faq-5-q": "Is there macOS or Linux support?",
      "faq-5-a": "Not in the first version — it's Windows 11 (64-bit) only. Both are technically possible and are on the list for after launch.",
      "faq-8-q": "How big a city can it generate?",
      "faq-8-a": "Measured: up to about 60 streets (a neighbourhood, ~360 m) generates in roughly 7 seconds — that's the size you iterate on. 100–250 streets takes tens of seconds. Above 250 streets is not recommended in the first version: split the city into district projects. Real threading and automatic tiling come after launch.",
      "faq-9-q": "Can I use the generated cities in a commercial game?",
      "faq-9-a": "Yes. Use the generated cities and the bundled assets in any product of yours, commercial or not, with no royalties and no attribution required. The one thing you can't do is resell the assets themselves as an asset pack. Full text: <a href=\"legal.html\">licences</a>.",
      "footer-desc": "One app to sketch, generate and populate procedural cities.",
      "footer-asset-licence": "Asset licence",
      "footer-eula": "Application licence (EULA)",
      "footer-meta": "© 2026 · Kaia · All rights reserved",
